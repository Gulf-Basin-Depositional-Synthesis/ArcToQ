"""
Simple APRX conversion test - similar to vince_test.py
...
2. Then in QGIS:
   & "C:\Program Files\QGIS 3.40.10\bin\python-qgis-ltr.bat" .\tests\simple_test.py
...
if __name__ == "__main__":
    ...
    try:
        ...
        print('  & "C:\\Program Files\\QGIS 3.40.10\\bin\\python-qgis-ltr.bat" .\\tests\\simple_test.py')
        print("="*60 + "\n")
        ...
        try:
            ...
            try:
                ...
                if not os.path.exists(json_path):
                    ...
                    print("  python tests\\simple_test.py")
                    sys.exit(1)
